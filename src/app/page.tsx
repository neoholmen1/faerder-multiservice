          ...
          <div className="faq-lead-enter mt-10 rounded-2xl bg-[#FFF8F3] p-6 shadow-[0_4px_24px_rgba(232,114,28,0.06)] sm:p-8">
            {!leadSent ? (
              <>
                ...
                <form onSubmit={handleLeadSubmit} className="mt-6 flex flex-col gap-4 sm:flex-row sm:gap-3">
                  <input
                    type="text"
                    placeholder="Navn"
                    aria-label="Navn"
                    ...
                    style={{ fontSize: 16, height: 56, paddingLeft: 20, paddingRight: 20 }}
                    className="flex-1 rounded-2xl border border-gray-200 bg-white text-text outline-none transition-all duration-200 focus:border-primary focus:ring-2 focus:ring-primary/10"
                  />
                  <input
                    type="tel"
                    placeholder="Telefon"
                  ...
                  <button
                    ...
                    className="btn-glow inline-flex w-full items-center justify-center gap-2 rounded-full bg-primary px-8 font-semibold text-white sm:w-auto"
                  >
