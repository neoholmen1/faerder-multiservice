      ...
      <section className="border-t border-gray-100 py-16 lg:py-20">
        <SectionReveal className="mx-auto max-w-3xl px-6">
          ...
          <div className="mt-12 flex flex-col items-start gap-5 sm:flex-row sm:items-center sm:justify-between">
            <h2 className="text-[clamp(1.25rem,3vw,1.75rem)] tracking-[-0.03em] leading-[1.2] text-text">
              Få et uforpliktende tilbud på {service.name.toLowerCase()}
            </h2>
            <div className="flex shrink-0 items-center gap-3">
              <Link
                href="/kontakt"
                className="btn-glow btn-shimmer inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-[14px] font-semibold text-white active:scale-[0.97]"
              >
